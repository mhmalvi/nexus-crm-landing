...
const SectionEight = () => {
  return (
    <div className="lg:min-h-[60vh] min-h-full w-full flex items-center justify-center lg:mt-0 mt-[64px]">
      <div className="lg:grid lg:grid-cols-8 lg:gap-8 flex flex-col justify-around lg:w-[69.5vw] w-[90vw] lg:min-h-[60vh] min-h-full lg:mt-0">
        ...
        <div className="col-span-4 flex flex-col lg:items-end items-start justify-center lg:min-h-full lg:mt-0 mt-[32px]">
          <h1 className="text-white lg:text-[36px] text-xl text-end font-semibold lg:leading-10">Why Us?</h1>

          <p className="text-white lg:w-5/6 w-[90vw] text-base lg:text-end text-start my-4">
