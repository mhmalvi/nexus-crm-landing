    ...
    <div className="lg:min-h-[100vh] min-h-[100vh] w-full flex items-center justify-center">
      <div className="lg:grid lg:grid-cols-8 lg:gap-8 flex flex-col flex-col lg:w-[69.5vw] w-[90vw] lg:min-h-[100vh] min-h-[87vh] lg:mt-0">
        <div className="col-span-5 flex flex-col lg:items-start items-center justify-center lg:min-h-full">
          <h6 className="text-[#4D8CFC] font-normal text-[2.5vw]">
            Single Solution to
          </h6>
          <h1 className="text-white text-[2.5vw] font-semibold lg:text-start text-center leading-10 m-0">
              ...
              tabMenu?.map((tab, idx) => {
                return (
                  <button
                    ...
                    } mb-[20px] lg:min-w-[8.5vw] ease-in duration-200 min-w-[50px] border-0 m-0 outline-0 px-[9px] lg:py-[16px] py-[5px] hidden whitespace-normal items-center justify-center flex-col text-white text-center font-[500] leading-[1.25] text-[1vw]`}
                    type="button"
                    role="tab"
        ...
        <div className="col-span-3 flex flex-col justify-center lg:items-start items-center lg:text-start text-center lg:h-full">
          <h1 className="text-[24px] font-semibold leading-[32px] lg:-mt-0 mt-[16px] text-start">
            <span className="text-[#4D8CFC]">{TabData?.title1}</span>{" "}
            <span className="text-white">{TabData?.title2}</span>
          </h1>
          <h6 className="text-[16px] leading-[20px] text-start text-white lg:text-start my-4">
            {TabData?.desc}
          </h6>
        </div>
      </div>
