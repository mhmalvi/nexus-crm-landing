...
const SectionThree = () => {
  return (
    <div className="lg:min-h-[60vh] min-h-full w-full flex items-center justify-center mb-[62px]">
      <div className="lg:grid lg:grid-cols-8 lg:gap-8 flex flex-col-reverse lg:w-[69.5vw] w-[90vw] min-h-full">
        <div className="col-span-5 flex flex-col lg:items-start justify-center lg:min-h-[30vh]">
          <h6 className="text-[#4D8CFC] lg:text-[32px] text-xl font-normal lg:leading-10">
            Instant Reports at
          </h6>
          <h1 className="text-white lg:text-[36px] text-xl lg:text-start font-semibold lg:leading-10">
            Your Fingertips
          </h1>
          <p className="lg:w-4/6 lg:text-base text-base lg:text-start text-white mt-8">
