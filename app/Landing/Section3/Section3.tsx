    ...
    <div className="lg:min-h-[60vh] min-h-[100vh] w-full flex items-center justify-center">
      <div className="lg:grid lg:grid-cols-8 lg:gap-8 flex flex-col flex-col lg:w-[69.5vw] w-[90vw] lg:min-h-[60vh] min-h-[87vh] lg:mt-0">
        <div className="col-span-5 flex flex-col lg:items-start items-center justify-center lg:min-h-full">
          ...
          <h1 className="text-white text-[36px] lg:text-start text-center leading-10 font-semibold">
            Your Fingertips
          </h1>
          <p className="text-white text-base lg:w-3/5 w-[90vw] lg:text-start text-center my-4">
            Effortlessly Access Managerial Reports and Save Time.
          </p>
          <p className="lg:w-4/6 text-base lg:text-start text-center">
