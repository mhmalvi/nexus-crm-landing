...
const SectionOne = () => {
  return (
    <div className="lg:min-h-[87vh] min-h-[95vh] w-full flex items-center justify-center">
      <div className="lg:grid lg:grid-cols-2 flex flex-col flex-col-reverse lg:w-[75vw] w-[90vw] min-h-[87vh] lg:mt-0 mt-[-10vh]">
        <div className="min-h-full flex flex-col lg:items-start items-center justify-center ">
          <h1 className="lg:text-[5rem] text-[2.5rem] font-[700] leading-[5vh] text-white lg:text-start text-center lg:mb-[24px] mb-0">
            Easiest Way to
          </h1>
          <h1 className="lg:text-[3.5rem] text-[1.5rem] font-[400] text-[#4D8CFC] lg:text-start text-center">
          ...
          <div className="mt-[5vh] w-full h-[15vh] ">
            <form className="flex flex-col lg:items-start justify-between h-full">
              <div className="w-full flex flex-col">
                ...
                <input type="email" className="lg:w-1/2 h-[5vh] pl-[14px] w-[90vw] lg:rounded-r-[12px] rounded-[12px]" placeholder="Enter your email address"/>
              </div>
