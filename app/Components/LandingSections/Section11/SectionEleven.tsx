        ...
        <div className="lg:w-2/3 w-[90vw] h-full flex flex-col bg-gradient-to-b from-[#8A7CFD7f] to-[#2596FB7f] rounded-md overflow-hidden">
            ...
            <div className="w-full py-8 flex items-center justify-center">
                <div className="w-full lg:h-[10vh] h-full lg:flex grid grid-cols-2 lg:flex-nowrap flex-wrap items-center justify-center lg:gap-4">
                    <div className="lg:p-8 p-2 lg:h-full h-[12vh] flex flex-col items-center justify-center border-r-2 lg:border-b-0 border-b-2 border-blue-400">
                    ...
                    <div className="lg:p-8 p-2 lg:h-full h-[12vh] flex flex-col items-center justify-center lg:border-r-2 lg:border-b-0 border-b-2 border-blue-400 ">
                    ...
                    <div className="lg:p-8 p-2 lg:h-full h-[12vh] flex flex-col items-center justify-center border-r-2 border-blue-400">
                    ...
                    <div className="lg:p-8 p-2 lg:h-full h-[12vh] flex flex-col items-center justify-center ">
